...
<script>
        ...
        this.$body = $("body")
        this.$calendar = $('#calendar{{$room->id}}'),
        this.$event = ('#calendar-events div.calendar-events'),
        this.$modal = $('#my-event-{{$room->id}}'),
    ...
    CalendarApp.prototype.onEventClick =  function (calEvent, jsEvent, view) {
        var $this = this;
            var form = $("<div></div>");
            var start = moment(calEvent._start).format("MMMM Do YYYY, H:mm A");
            var end = moment(calEvent.end).format("MMMM Do YYYY, H:mm A");
            form.append("<h3><strong> "+ calEvent.title + "</strong></h3>");
           form.append("<div class='input-group'>" + start +  " " + end +
                
                "</div>");
            form.append("<span> "+ calEvent.description + "</span>");
            form.append("<span> REMARKS :"+ calEvent.remarks + "</span>");
            $this.$modal.modal({
                backdrop: 'static'
            });
